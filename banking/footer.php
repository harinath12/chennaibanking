 <!-- Page Footer-->
    ...
    <div class="sticky-container">
          <ul class="sticky">
            <li class=" phone">
             <a href="tel:#"><span><label class="side-contact fa fa-phone" aria-hidden="true"></label></span> 
            ...
            <li>
             <a href="mailto:support@Chennaibanking.com"><span><label for="email" class="side-contact fa fa-envelope" aria-hidden="true"></label></span>
