 <!-- Page Footer-->
    ...
    <div class="sticky-container">
          <ul class="sticky">
            <li class=" phone">
             <a href="tel:#"><span><label class="contact fa fa-phone" aria-hidden="true"></label></span> 
              <span class="vertical">960-000-0011</span></a>
            </li>
            <li class=" phone">
              <a href="https://wa.me/9894429046"><span><label for="" class="contact fa fa-whatsapp" aria-hidden="true"></label></span>
              <span class="vertical">960-000-0011</span></a>
            </li>
            <li>
             <a href="mailto:support@Chennaibanking.com"><span><label for="email" class="contact fa fa-envelope" aria-hidden="true"></label></span>
             <span class="vertical">support@Chennaibanking.com</span></a>
            </li>
