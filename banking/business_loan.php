<?php /* Template Name: business_loan */ ?>
            ...
            <h5><b>Get the best <?php the_title(); ?> that suits your requirement by filling the below Details.</b></h5>
              <div class="row">
                  ...
                  <div class="row">       
                      ...
                      <div class="col-sm-6">
                          <div class="form-wrap ">
                            <label>Your Company Type</label>
                            <select class="form-control" required  ng-model="newEnquiry.cmpytype">
                              <!-- <option value="" disabled selected>Company Type</option> -->
                              <option>Proprietorship company</option>
                  ...
                  <div class="row">                        
                        <div class="col-sm-6">
                          <div class="form-wrap">
                            <label>Current account maintained in</label>
                              <div class="form-control" ng-click="$event.stopPropagation();pageInfo.showBank=true">
                                  <abbr ng-if="selectedBank(newEnquiry.cab) == 0">Choose bank</abbr>
                                  <span ng-repeat="(b,v) in newEnquiry.cab" class="custom-multiselect" ng-show="v">{{b}}<i ng-click="newEnquiry.cab[b]=false" class="fa fa-close"></i></span>
                              </div>
                                <div ng-click="$event.stopPropagation();" class="citylist" ng-show="pageInfo.showBank">
                                 <?php
                                  ...
                                  foreach ($banks as $key => $value) {?>
                                    <span><input id="bank<?= $key?>" type="checkbox" ng-model="newEnquiry.cab['<?= $value['name'];?>']"> <label for="bank<?= $key?>"><?= $value['name'];?></label></span>
                                  <?php } ?>
                              </div>   
                            ...
                            <div class="form-wrap">
                              <label>Are you paying any monthly EMI?</label> 
                                <p><label class="rediobtn">Yes
                                  <input type="radio" ng-model="newEnquiry.cc" value="Yes" name="cc" required>
                                  <span class="checkmark"></span> 
                                </label>
