    ...
    <div class="container" ng-controller="CCFormController">
      ...
      <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"  id="onload">
        ...
        <div class="modal-body" > 
          <form ng-click="pageInfo.showcity = false;"  ng-if="!pageInfo.enquirydone" name="pageInfo.enquiryform" ng-class="{formSubmitted: pageInfo.formSubmitted}" autocomplete="off" ng-init="newEnquiry.etype='<?php the_title(); ?>'">
            <h5><b>Get the best <?php the_title(); ?> that suits your requirement by filling the below Details.</b></h5>
              <div class="row">
                              ...
                              <div class="form-wrap">
                                <label>Gender</label>
                                  ...
                                  <label class="rediobtn">Female
                                    <input ng-model="newEnquiry.gender" value="Female" type="radio" name="gender">
                                    <span class="checkmark"></span>
                                  </label></p>
                              </div>
                      </div>
                ...
                <div class="row">
                <div class="col-sm-12">
                  <p><input ng-model="newEnquiry.tnc" required="" type="checkbox" name="tnc" checked="checked"> I accept the <a href="#">Terms & conditions</a> and allow Chennai Banking to call or send message.</p>
